...
mods.mysticalagriculture.InfusionCrafting.addRecipe("chroma_ingot", <item:kubejs:chroma_ingot> * 2, [<item:kubejs:assembled_technical_ingot>, <item:appliedenergistics2:singularity>, <item:kubejs:dense_magical_ingot>, <item:iceandfire:dragonsteel_lightning_ingot>, <item:kubejs:assembled_technical_ingot>, <item:iceandfire:dragonsteel_ice_ingot>, <item:kubejs:dense_magical_ingot>, <item:iceandfire:dragonsteel_fire_ingot>]);
